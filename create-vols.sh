...
if [ "$#" -ne 2 ]; then
  echo "Please give a base name for the volumes and also dir for github key"
  exit -1
fi
...
docker create -ti -w /home/flower -v "/Volumes/shared/docker/work/hmrc/docker-services:/home/flower/dev/ddcnls-docker" -v $1-etc:/etc -v $1-usr:/usr -v $1-bin:/bin -v $1-var:/var -v $1-home:/home -v $1-dev:/home/flower/dev --name $1 --rm lavenderflowerdew/alpine-sbt:openjdk-8-sbt-0.13.8

docker cp /Volumes/Lavender/Work/github $1:/home/flower
docker cp /Volumes/Lavender/Work/github.pub $1:/home/flower
...
echo '' >> start.sh
echo $"/usr/local/bin/docker run -ti -w /home/flower -v \"/Volumes/shared/docker/work/hmrc/docker-services:/home/flower/dev/ddcnls-docker\" -v $1-etc:/etc -v $1-usr:/usr -v $1-bin:/bin -v $1-var:/var -v $1-home:/home -v $1-dev:/home/flower/dev --name $1 --rm lavenderflowerdew/alpine-sbt:openjdk-8-sbt-0.13.8 /bin/zsh" >> start.sh
chmod +x start.sh
